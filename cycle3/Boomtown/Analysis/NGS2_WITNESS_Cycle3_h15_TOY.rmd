...
library ("pacman")
pacman::p_load(rstan, rstanarm, ggplot2, Hmisc, httr, bridgesampling, DT, dplyr, bayesplot, knitr, lme4, formatR, caret, pROC, formatR, foreach, doParallel, forcats, tidyr, car, evaluate)
library(RCurl)
